...
<span class="title">Proyectos 🖇️</span>

<div class="projects">
{projects.map((project) => (
<Fragment><div class="project">
<picture>
...
<Fragment><figure>
<img src={`images/${technology.image}`} alt={`${technology.name}-image`} loading="lazy" />
</figure></Fragment>
))}
</div>
<div class="links">
...
<div class="more">
<a href="https://github.com/eddmen2812/" target="_blank" class="btn">Ver más...</a>
</div>
</section>
...
<style>{`
  ...
  .description .technologies figure {
    height: 2.1rem;
  }

  .description .technologies figure img {
    width: 100%;
    height: 100%;
    object-fit: cover;
  }
